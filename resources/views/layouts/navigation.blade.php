            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if(auth()->user()->isSuperAdmin() || auth()->user()->isAdmin() || auth()->user()->isStore())
                        ...
                        <x-nav-link :href="route('emis.index')" :active="request()->routeIs('emis.*')">
                            {{ __('EMIs') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->isSuperAdmin() || auth()->user()->isAdmin() || auth()->user()->isStore())
                ...
                <x-responsive-nav-link :href="route('emis.index')" :active="request()->routeIs('emis.*')">
                    {{ __('EMIs') }}
                </x-responsive-nav-link>
            @endif

            <x-responsive-nav-link :href="route('demands.index')" :active="request()->routeIs('demands.*')">
                {{ __('Demands') }}
            </x-responsive-nav-link>
        </div>
